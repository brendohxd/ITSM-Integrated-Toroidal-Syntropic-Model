...
🔹 **Script 2: JADES-GS-z14-0 Timeline Analysis**
...
🔹 **Script 3: Bullet Cluster Phase-Space Decoupling**
...
🔹 **Script 4: Hubble Tension Geometric Resolver**
...
🔹 **Script 5: Macroscopic Torsional Entrainment**
...
🔹 **Script 6: Covariant Stability (Drag Saturation)**
...
🔹 **Script 7: NANOGrav Stochastic Toroidal Resonance**
...
🔹 **Script 8: Syntropic Volume Decay (DESI 2024)**
...
|---|---|
| `Manuscript/` | Complete, publication-ready LaTeX Manuscript (`Main.tex`) and finalized PDF. |
| `Scripts/` | 8 executable Python engines for all kinematic and assembly simulations. |
| `SPARC_data/` | The 175 empirical galaxy `.dat` files required for Script 1. |
| `Assets/` | High-resolution `.png` figures generated by the scripts and used in the manuscript. |
