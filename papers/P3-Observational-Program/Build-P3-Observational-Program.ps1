# Build P3 PDF directly to its canonical content-title + versioned name.
# Prerequisite: conda activate itsm_env (if the local TeX environment requires it)
#
# Usage:
...
$Author = "Boyd"
$Year = "2026"
$ContentSlug = "Gate-Structured_Observational_Falsification_Program_ITSM"
