...
\begin{equation}
c_s^2 = \frac{\mathcal{L}_X}{\mathcal{L}_X + 2X\mathcal{L}_{XX}} = \frac{1 + \frac{1}{3}\left(1+\frac{X}{a_0^2}\right)^{-1/2}}{1 + \frac{1}{3}\left(1+\frac{X}{a_0^2}\right)^{-1/2} - \frac{X}{3a_0^2}\left(1+\frac{X}{a_0^2}\right)^{-3/2}}
\end{equation}
