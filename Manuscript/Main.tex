...
\textbf{Physical Interpretation of the Running Syntropic Index $n(z)$.} The syntropic decay index $n$ is not a single universal constant; it is a physically running parameter that encodes the redshift-dependent coupling strength of the Superfluid Plenum to the expanding manifold. Its value at different epochs reflects different physical regimes of the plenum:
\begin{enumerate}
    \item $n \approx 0.003$ at $z \approx 0$ (global joint fit): The late-universe plenum is kinematically locked to the Hubble flow and mimics a cosmological constant. The acoustic shear energy has been transferred to large-scale structure, leaving the background vacuum quasi-static.
    \item $n \approx 0.81$ from DESI BAO at $0.1 < z < 4.2$: The intermediate-redshift plenum is in the active syntropic intake phase, driving mild dark energy evolution consistent with the DESI 2024 $w_0$-$w_a$ tension.
    \item $n \approx 1.44$ from CMB/CLASS and structure formation at $z > 2$: The early-universe plenum is in the fully active thermodynamic intake phase, supplying the additional vacuum scaffolding that enables rapid baryonic condensation at $z > 14$.
\end{enumerate}
This redshift evolution of $n$ is a structural prediction of the open-manifold thermodynamic circuit: the syntropic coupling weakens as the toroidal manifold expands and the plenum energy density dilutes. The suite of fitted $n$ values across different datasets is therefore not inconsistent; it is a multi-epoch map of the plenum's running thermodynamic state.
