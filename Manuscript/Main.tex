...
Two important limitations are explicitly acknowledged. (i) The phonon-mediated acceleration formula $g_{\text{tot}} = g_{\text{bar}} + \frac{2}{3}\sqrt{g_{\text{bar}}\,a_0}$ is derived in the static, non-relativistic transition regime; the complete baryonic matter-phonon coupling action and its renormalization group properties remain to be formalized. (ii) The phonon sound speed exhibits a transient superluminal excursion ($c_s^2 \approx 1.11$) at the transition scale $X \sim a_0^2$; this is consistent with established k-essence behavior \cite{babichev_cs2} and does not imply macroscopic causality violation, but requires further analysis in the context of Lorentz-invariant effective field theory.
