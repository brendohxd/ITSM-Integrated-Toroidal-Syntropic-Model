...
\subsection{Complete finite-wavenumber constraint source}

Let $M=M_{\rm cos}^2$ and let $D_i$ denote the physical derivative on the
unperturbed FRW leaf.  Expanding the complete parent action and using the
Friedmann equation gives the lapse component
\begin{align}
 J_{2,N}={}&3M\dot{\mathcal R}^{\,2}
...
\begin{align}
 J_{2,\Sigma}={}&-2M\left(\mathcal R\dot{\mathcal R}
 ...
 -K_Q\dot\pi D_i\pi .
\end{align}
The linear terms of the same expansion regress exactly to the previously
verified $J_1$.  The inverse Laplacian in
...
Writing
\begin{equation}
 \mathcal D=C_{14}D_{123}q_{\rm phys}^2-2D_{123}V+4M^2H^2,
\end{equation}
direct completion of the square gives
\begin{equation}
 \mathcal L_{4,\rm constraint}
 =\frac{(C_{14}q_{\rm phys}^2-2V)J_{2,\Sigma}^2
 -D_{123}J_{2,N}^2-4MHJ_{2,N}J_{2,\Sigma}}{2\mathcal D}
 =-\frac12J_2^{\mathsf T}C^{-1}J_2 .
 \label{eq:complete-j2-schur}
\end{equation}
Thus the complete finite-$q$ source and constraint-induced quartic functional
pass.  Equation~\eqref{eq:complete-j2-schur} is not the complete quartic
action: the direct multi-sector contact block, regular physical-scalar
projection and gauge-regular $2\!\to\!2$ amplitude remain open.
