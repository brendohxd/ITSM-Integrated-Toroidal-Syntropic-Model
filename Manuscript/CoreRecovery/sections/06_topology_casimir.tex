...
energy density used in CBR-001 is
\begin{equation}
...
universal cycle-counting coefficient.
...
\end{equation}
Free Casimir stress redshifts as $a^{-4}$ and cannot maintain this source.  A
future CBR-002 test must derive any additional shape, driven or memory stress
without inserting the target ratio into a coefficient.
