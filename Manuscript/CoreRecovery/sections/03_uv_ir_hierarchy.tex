...
normalization and $c_s^2=c_{123}/c_{14}$.  This bounded vertex basis is not the
physical cosmological cubic action.  It omits non-collinear momentum triads,
the second-order lapse and scalar-shift response, evolving-background terms
and condensate--metric mode projection.  Consequently no invariant physical strong-coupling scale is assigned; the action-dependent warnings and healthy-extension results in Refs.~\cite{blas2010,papazoglou2009} reinforce that boundary.  UVIR-003 remains open.
