...
\subsection{Reconciling the Cosmic Age and BBN: The Plenum as Effective Matter}
...
\textbf{ITSM (This Work)} & \textbf{8.57} & \textbf{0/galaxy ($k=0$ extra)} & \textbf{27854 (Raw $\chi^2$)} & \textbf{Fixed first-principles point} \\
\bottomrule
\end{tabular}
\end{table*}
