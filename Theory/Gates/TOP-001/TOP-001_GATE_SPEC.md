...
6. no free-field **\(13/12\)** attractor, **\(H_0=72.97\)**, topology-alone
   \(a_0\), or \(\Cobs=2/3\) packaging is restored?
...
| \(\Cobs=2/3\) from dimension counting / projection | **Rejected** as TOP derivation |
...
| F6 | Topology-alone derivation of \(a_0\) or \(\Cobs\) presented as TOP-Derived |
...
| \(\Cobs=2/3\) from geometry counting | Rejected as TOP derivation |
