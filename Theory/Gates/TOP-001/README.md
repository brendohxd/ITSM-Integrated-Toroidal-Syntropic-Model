# TOP-001 — Shape-modulus and toroidal-boundary recovery scaffold

**Gate status:** **OPEN** (scaffold only; no Derived topology or cosmology)
**Branch:** `recovery/v12-core-architecture`
**Date:** 2026-08-03
**Claim class:** founding **toroidal-shape identity** → formal **Open** research object

**Authority (read-only; this package does not edit them):**

- `Theory/Core/ITSM_Master_Research_Plan.md` — pillar “toroidal shape”; formal home TOP-001
- `Theory/Core/ITSM_Core_Architecture.md` §3.6 topology/moduli; §8 CBR-001 baseline
- `Theory/Core/ITSM_Core_Recovery_Plan.md` — TOP-001 / VOR-001 shape and circulation
- `papers/P2-Rectangular-T3-Casimir/` + `Analysis/Casimir/CBR-001/` — free-field Casimir baseline
...
## Separation rules (claim firewall)
...
Research-only scaffolding for independent review. Does **not** amend the Master
Plan, claim ledger, manuscripts, or other gates by itself. The independently
reviewed package may be integrated as an Open scaffold without upgrading any
physics claim.
