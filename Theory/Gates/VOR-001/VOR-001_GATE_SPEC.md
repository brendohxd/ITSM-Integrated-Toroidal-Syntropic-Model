...
5. no automatic packaging into $a_0$, $C_{\mathrm{obs}}$, cosmology, or lensing?
...
| $C=2/3$ or $C_{\mathrm{obs}}=2/3$ from vortex geometry | **Rejected** unless independently rederived in MAT/UVIR |
...
| Derived $C_{\mathrm{obs}}$ or $C=2/3$ from vortices | MAT/UVIR matching |
