...
|---|---|---|---|---|
| 1 | Setup & Clone | Clone CLASS, investigate background.c and build tools | none | IN_PROGRESS (f839fe29-c1d3-449d-8825-5b4890ee9399) |
| 2 | Core C Modification | Implement ITSM expansion history in background C code | M1 | PLANNED |
| 3 | Compile & Wrap | Compile CLASS C code and build/install classy wrapper | M2 | PLANNED |
